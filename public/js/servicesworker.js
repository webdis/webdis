...
"use strict";
/*!****************************************!*\
  !*** ./resources/js/servicesworker.js ***!
  \****************************************/
...
var PRECACHE_URLS = ['/css/app.css', '/js/app.js', '/android-chrome-192x192.png', '/android-chrome-512x512.png', '/favicon-16x16.png', '/favicon-32x32.png', '/favicon.ico', '/mstile-70x70.png', '/mstile-144x144.png', '/mstile-150x150.png', '/mstile-310x310.png', '/mstile-310x150.png', '/safari-pinned-tab.svg'];
var OFFLINE_VERSION = 1;
var CACHE_NAME = "offline";
var OFFLINE_URL = "/offline"; // The install handler takes care of precaching the resources we always need.

self.addEventListener('install', function (event) {
  event.waitUntil(caches.open(PRECACHE).then(function (cache) {
    return cache.addAll(PRECACHE_URLS);
  }).then(_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var cache;
...
self.addEventListener('activate', function (event) {
  ...
  event.waitUntil(_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
...
self.addEventListener('fetch', function (event) {
  if (event.request.mode === "navigate") {
    event.respondWith(_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
