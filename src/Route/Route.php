...
class Route implements \Serializable
{
    ...
    private $host = '';
    private $schemes = [];
    private $methods = ['GET', 'HEAD', 'POST', 'PUT'];
    private $defaults = [];
     ...
     */
    public function __construct(string $path, array $controller = null, array $methods = ['GET', 'HEAD'])
    {
        $this->path = $path;
        ...
        $this->defaults = [
            '_controller' => 'App\\Controller\\' . $controller[0] . '::' . $controller[1],
        ];
